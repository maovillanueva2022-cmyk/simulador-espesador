...
class PDF_Memoria(FPDF):
    def header(self):
        self.set_font('Arial', 'B', 16); self.cell(0, 10, 'Memoria de Cálculo: Diseño de Espesador', 0, 1, 'C'); self.set_font('Arial', '', 10); self.cell(0, 10, f"Fecha de Emisión: {datetime.now().strftime('%d-%m-%Y')}", 0, 1, 'R'); self.ln(10)
    def footer(self):
